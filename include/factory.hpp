...
class Factory {
private:
    void remove_receiver(NodeCollection<Node>::const_iterator& collection, ElementID id) =0;
...
public:
    ...
    bool is_consistent()=0; //todo
    void do_deliveries(Time)=0;//todo
    void do_package_passing()=0;//todo
    void do_work(Time)=0; //todo
